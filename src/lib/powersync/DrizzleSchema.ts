...
export const user_profiles = sqliteTable("user_profiles", {
    ...
    created_at: text("created_at").default(DateTime.now().toISO()).notNull(),
    user_role: text("user_role" /* user-defined type */).$type<UserRole>().notNull(),
});
 ...
 *  ────────────────────────────────────────────────────────────────────────────**/
export const processed_ctd_rbr_data_values = sqliteTable("processed_ctd_rbr_data_values",
    {
        id: text("id").notNull().primaryKey(),
 ...
 *  ────────────────────────────────────────────────────────────────────────────**/
export const processed_nutrient_ammonia_data = sqliteTable("processed_nutrient_ammonia_data",
{
    id: text("id").notNull().primaryKey().default(uuidv4()),
    processed_data_id: text("processed_data_id").notNull().references(() => processed_data_improved.id),
    user_id: text("user_id").notNull().references(() => user_profiles.id),
 ...
 *  ────────────────────────────────────────────────────────────────────────────**/
export const raw_nutrient_ammonia_data = sqliteTable("raw_nutrient_ammonia_data", {
    id: text("id").notNull().primaryKey().default(uuidv4()),
    ammonia: real("ammonia").notNull(),
 ...
 *  ────────────────────────────────────────────────────────────────────────────**/
export const processed_kraken_uniq_stdout = sqliteTable("processed_kraken_uniq_stdout", {
    id: text("id").notNull().primaryKey(),
    user_id: text("user_id").notNull().references(() => user_profiles.id),
    org_id: text("org_id").notNull().references(() => organizations.id),
    sample_id: text("sample_id").notNull().references(() => sample_group_metadata.id),
